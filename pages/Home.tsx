  ...
  return (
    <div className="relative w-full overflow-hidden bg-neutral-950">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 overflow-hidden">
        ...
        {/* Text Content */}
        <div className="relative z-20 text-center max-w-5xl space-y-10">
          
          <div className="flex flex-col items-center gap-4 animate-pulse-slow">
            <div className="h-16 w-px bg-gradient-to-b from-transparent via-orange-600 to-transparent"></div>
            <p className="font-mono text-[10px] text-orange-600 uppercase tracking-[0.4em]">
               Provenance Protocol 1.0
            </p>
          </div>
          
          <h1 className="font-serif text-6xl md:text-8xl lg:text-9xl text-neutral-200 leading-[0.85] tracking-tighter mix-blend-lighten">
            The Fragility <br/>
            <span className="italic font-light text-neutral-500">of the</span> Real.
          </h1>

          <p className="font-sans font-light text-neutral-400 text-lg md:text-xl max-w-lg mx-auto leading-relaxed">
          ...
          <div className="pt-12 flex flex-col sm:flex-row gap-8 justify-center items-center">
            <Link to="/certify" className="group relative px-10 py-5 bg-neutral-100 text-black overflow-hidden shadow-[0_0_40px_rgba(255,255,255,0.1)]">
               ...
               <span className="relative z-10 flex items-center gap-4 text-xs font-bold uppercase tracking-widest group-hover:text-white transition-colors">
                 Authenticate File <ArrowRight size={14}/>
               </span>
            </Link>

            <button onClick={scrollToProcess} className="group px-8 py-5 border-b border-white/20 hover:border-orange-600 text-white transition-all">
               <span className="text-xs font-bold uppercase tracking-widest flex items-center gap-3 group-hover:text-orange-600 transition-colors">
      ...
      <section id="process" className="py-40 px-8 relative z-20 bg-neutral-950 border-t border-white/5">
         <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
               ...
               <div className="space-y-16">
                  ...
                  <div className="space-y-12">
                     {[
                       ...
                       <div key={i} className="group flex gap-8 items-start border-l border-white/10 pl-8 hover:border-orange-600 transition-colors duration-500">
                          <span className="text-xs font-mono text-neutral-600 group-hover:text-orange-600 transition-colors mt-1">0{i+1}</span>
                          <div className="space-y-2">
                             <h3 className="font-serif text-2xl text-white group-hover:text-orange-500 transition-colors">{item.title}</h3>
               ...
               {/* Visual Abstract */}
               <div className="relative h-[600px] w-full border border-white/5 bg-white/[0.01] flex items-center justify-center p-8 overflow-hidden group">
                  ...
                  {/* Center Graphic */}
                  <div className="relative z-10 w-64 h-64 border border-orange-600/30 rounded-full flex items-center justify-center animate-[spin_20s_linear_infinite]">
                     ...
                     <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-8 bg-orange-600"></div>
                     <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-px h-8 bg-orange-600"></div>
                  </div>
                  
                  <div className="absolute bottom-8 left-8 font-mono text-[9px] text-neutral-500 uppercase tracking-widest">
